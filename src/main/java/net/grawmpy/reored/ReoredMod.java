...
@Mod("reored")
public class ReoredMod {
	public static final Logger LOGGER = LogManager.getLogger(ReoredMod.class);
	public static final String MODID = "reored";
